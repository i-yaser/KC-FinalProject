                                       ...
                                       VStack {
                                           VStack{
                                               ...
                                               HStack{
                                                   ...
                                                   Button {
                                                       Photo4 = "sport11"
                                                       Title4 = "وضعية الطرف النائم"
                                                       Dis4 = "لا احد ينكر فائدة المشي كل يوم ،ابدي صباح ب المشي القليل ل تكتسب الطاقه الكافيه لبقيت اليوم..."
                                                   } label: {
                                                       Image(systemName: "arrowshape.turn.up.right.circle.fill")
                                                           .foregroundColor(.black)
